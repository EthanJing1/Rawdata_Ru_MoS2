...
ind = data.wavelength>458&data.wavelength<1200;
...
%% Truncate in Time
ind = data.time>-0.5&data.time<7100;
...
model.kinmod=@(t)buildkineticmodel(data,0,100,...
[ ...
 -2/t(1) 1/t(1) 1/t(1) 0 0 0 0 0;...
 1/t(1) -2/t(1)-1/t(2)-1/t(3) 1/t(1) 1/t(2) 0 0 0 0; ...
 1/t(1) 1/t(1) -2/t(1)-1/t(2) 0 1/t(2) 0 0 0; ...
 0 1/t(2) 0 -2/t(1)-1/t(2) 1/t(1) 1/t(1) 0 0; ...
 0 0 1/t(2) 1/t(1) -2/t(1)-1/t(2)-1/t(4) 1/t(1) 0 0; ...
 0 0 0 1/t(1) 1/t(1) -2/t(1) 0 0; ...
 0 1/t(3) 0 0 0 0 -1/t(5) 1/t(5); ...
 0 0 0 0 1/t(4) 0 1/t(5) -1/t(5)...
],[1 1 1 1 1 1 0 0]);
% Initial guess for values of t
tplus=700;
x=0.9;
tminus=x*tplus;
model.initialguess = [1000 800 tplus tminus 150000];
% the labels for t, used for output
model.fitlabels={'tau_1','tau_2','tau3','tau4','tau5','tau6','tau7','tau8'};
...
figure(3)
sp=checkmdecay(:,8)-checkmdecay(:,7);
semilogx(checkmtime,sp/max(abs(sp)),checkmtime,(a-1)/max(abs(a-1)))
%selectwavelength=[460 480 523 591 674 988 1280];
...
CheckModelSW(data,model,[460 480 523 650 674 988 1280 ])
...
model.kinmod=@(v)buildmodel(data,dt,0,v(1),[ 1/v(2) 1/v(3) 1/v(4)]);

% initial guess for v
model.initialguess = [0.6 1 1000 10000];
% the labels for v, used for output
model.fitlabels={'t0','irf','tau_2','tau_3','tau_4'};
...
CheckModelSW(data,model,[420 432 450 483 531 628 685]);
%% SVD Global Fitting
